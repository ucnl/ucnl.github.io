...
| PeriodMs | Период выдачи информации в миллисекундах, <br/>0 - вывод показаний отключен, <br/>1 - тандемный вывод (сразу после любого исходящего сообщения от устройства управляющей системе)<br/>
или значение от 500 до 60000 (0.5 - 60 секунд) |
