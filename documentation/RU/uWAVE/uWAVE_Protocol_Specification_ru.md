...
- [3. Режимы работы устройства](#3-%D1%80%D0%B5%D0%B6%D0%B8%D0%BC%D1%8B-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B-%D1%83%D1%81%D1%82%D1%80%D0%BE%D0%B9%D1%81%D1%82%D0%B2%D0%B0)
   ...
   - [3.2. Командный режим](#31-%D0%BA%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%BD%D1%8B%D0%B9-%D1%80%D0%B5%D0%B6%D0%B8%D0%BC)
   - [3.3. Пакетный режим](#32-%D0%BF%D0%B0%D0%BA%D0%B5%D1%82%D0%BD%D1%8B%D0%B9-%D1%80%D0%B5%D0%B6%D0%B8%D0%BC)
...
| isPTMode | '0' - пакетный режим неактивен, '1' - пакетный режим активен |
| ptLocalAddress | Адрес локального модема в пакетном режиме, 0 .. 255 |
| *	| Разделитель контрольной суммы NMEA |
| hh	| Контрольная сумма NMEA |
| \<CR\>\<LF\> | Конец сообщения |
...
| isPTMode | '0' - пакетный режим неактивен, '1' - пакетный режим активен |
| ptLocalAddress | Адрес локального модема в пакетном режимеб 0 .. 255 |
| *	| Разделитель контрольной суммы NMEA |
| hh	| Контрольная сумма NMEA |
| \<CR\>\<LF\> | Конец сообщения |
...
| target_ptAddress | Адрес удаленного модема, 0 .. 255 |
...
Формат сообщения: **`$PUWVI,x,x,h--h*hh <CR><LF>`**
...
Формат сообщения: **`$PUWVJ,x,h--h*hh <CR><LF>`**
...
| sender_ptAddress | Адрес удаленного модема (отправителя), 0 .. 255 |
| dataPacket | Массив байт в HEX-формате с префиксом '0x', например для строки '123' 0x313233. Максимальный размер пакета 64 байта. Если поле пустое, то текущая передача будет отменена. |
| *	| Разделитель контрольной суммы NMEA |
| hh	| Контрольная сумма NMEA |
| \<CR\>\<LF\> | Конец сообщения |
