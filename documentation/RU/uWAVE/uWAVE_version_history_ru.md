[Главная](/README_RU) ❯ [Гидроакустические модемы](/underwater_acoustic_modems_ru) ❯ **История версий и изменений: uWave**
...
| Актуальная версия ПО | **uWave [JULY] 1.34** от 22-NOV-2023 |
| :--- | :--- |
| | |

| Дата | Версия встроенного ПО | Описание |
| :--- | :--- | :--- |
| 20-MAR-2025 | System: (кроме uWave USBL) <br/> Core: uWAVE [JULY] v2.5 | Обширный рефакторинг |
| 22-NOV-2023 | System: (все) <br/> Core: uWAVE [JULY] v1.34 | - BUG FIX: ошибочные данные с датчика глубины после продолжительной работы в некоторых случаях |
