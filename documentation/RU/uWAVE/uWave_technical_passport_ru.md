...
Помимо вышеуказанного, гидроакустический модем **uWave USBL** предназначен для:
- определения горизонтального угла прихода сигнала от других модемов семейства **uWave**
...
Четырехзначные заводские номера нанесены на нижний (противоположный вводу кабеля) торец модема методом горячего клеймения.
