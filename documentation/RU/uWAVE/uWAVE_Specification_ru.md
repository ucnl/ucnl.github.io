...
цифровую связь между 254 абонентами в акваториях 1000 х 1000 метров, используя кодовый режим и режим прозрачного канала. Предельно малый 
...
| СКОРОСТЬ ПЕРЕДАЧИ ДАННЫХ | 78/156/314<sup>[2](#footnote2)</sup> бит/с |
...
| СХЕМА РАЗДЕЛЕНИЯ АБОНЕНТОВ | 20<sup>[2](#footnote2)</sup> кодовых каналов |
