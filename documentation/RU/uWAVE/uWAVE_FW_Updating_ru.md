...
### Шаг 5.1
Если у вас нет файла прошивки для этого модема, обратитесь к [разработчику](mailto:hello@unavlab.com) для получения файла прошивки. В письме укажите серийный номер устройства:
