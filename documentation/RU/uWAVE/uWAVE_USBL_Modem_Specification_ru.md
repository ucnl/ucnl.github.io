[Главная](/README_RU) ❯ [Гидроакустические модемы](/underwater_acoustic_modems_ru) ❯ **Спецификация устройства: uWave USBL Modem**
...
| НОМИНАЛЬНАЯ ТОЧНОСТЬ ОПРЕДЕЛЕНИЯ ГОРИЗОНТАЛЬНОГО УГЛА ПРИХОДА СИНГНАЛА<sup>[5](#footnote5)</sup> | 2° |
| МАКСИМАЛЬНЫЙ КОМПЕНСИРУЕМЫЙ ВСТРОЕННЫМ ИНКЛИНОМЕТРОМ НАКЛОН ПРИБОРА ОТНОСИТЕЛЬНО ВЕРТИКАЛИ (КРЕН/ДИФФЕРЕНТ) | +/- 30° |
| РАБОЧИЙ КОНУС (ОТНОСИТЕЛЬНО ГОРИЗОНТАЛИ) | 85° |
| НЕСУЩАЯ | 20050 Гц |
...
| РАЗРЕШЕНИЕ ДАТЧИКА ГЛУБИНЫ (локально)<sup>[9](#footnote8)</sup> | 0.01 м |
| РАЗРЕШЕНИЕ ДАТЧИКА ГЛУБИНЫ (удаленно)<sup>[9](#footnote8)</sup> | 0.1 м |
