...
________________
<a name="footnote1"><sup>1</sup></a> При работе с другим **uWAVE USBL Modem** или при работе с модемами [uWAVE Max](uWAVE_Max_Specification_ru.md). Максимальная дальность связи со стандартными модемами [uWAVE](uWAVE_Specification_ru.md) составляет 1000 метров  
