...
- 4. Подсоединить пробудитель посрдеством переходника к разъему (3) **Приемник**
- 5. Включить модуль программирования, переведя тубмлер (7) **Питание** в положение **Вкл**
- 6. Убедиться, что модуль перешел в режим программирования: индикатор (6) **Состояние** часто моргает
  - 6.1. Если индикатор (6) **Состояние** не сигнализирует о переходе в режим программиования, акустический пробудитель не может быть запрограммирован. Попробуйте повторить действия. Если ситуация повторится, обратитесь в службу технической поддержки
- 7. Следует помнить, что модуль автоматически выходит из режима программирования через 2 минуты
...
- 10. Если программирование пробудителя прошло успешно, индикатор (6) **Состояние** перестает моргать и горит постоянно в течение двух секунд, после чего снова начинает моргать, сигнализируя о готовности к программированию
  - 10.1. Если при программировании произошла ошибка, то на две секунды загорится индикатор (5) **Запрос**. В этом случае попробуйте повторить все действия с начала. Если ошибка будет повторятся, обратитесь в службу технической поддержки
