...
При получении сигнала от управляющего устройства в актуаторе задействуется мотор-редуктор, откручивающий стопорную гайку, связанную с якорем, и, тем самым позволяющий всплыть актуатору с поплавком-катушкой под действием архимедовой силы.
