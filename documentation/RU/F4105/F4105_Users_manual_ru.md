...
6. Убедиться, что модуль перешел в режим программирования: индикатор (6) **Состояние** часто моргает
   - Если индикатор (6) **Состояние** не сигнализирует о переходе в режим программиования, акустический пробудитель не может быть запрограммирован. Попробуйте повторить действия. Если ситуация повторится, обратитесь в службу технической поддержки
