...
- Заводские номера на навигационных приемниках RedNode наносятся на торец, противоположный от кабеля методом горячего клеймения; Серийные номера доступны программно, при подключении устройства к ПК;
