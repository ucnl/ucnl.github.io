...
> Навигационный водолазный приемник оснащен пьезокнопками для исключения возможности выхода устройства из строя из-за попадания водны внутрь корпуса через уплотнения механических кнопок. Пьезокнопки имеют некоторые особенности функционирования, в частности, отсутствие обратной связи при нажатии. Кнопки воспринимают только резкое изменение давления, поэтому, все нажатия с целью управления устройством должны быть краткими.
...
- сервисном, когда требуется сопряжение с ПК с целью конфигурации устройства, загрузки путевых точек и/или выгрузке трека;
- навигационном, когда ведется прием сигналов буев и вырабатывается навигационная информация.

##### 2.3.2.1. Режим навигации
Режим навигации - основной режим работы навигационного приемника. Переход в него осуществляется при включении устройства, когда оно не располагается на зарядной площадке. Для включения устройства необходимо одновременно нажать обе кнопки, расположенные по бокам интерфейсного блока.



##### 2.3.2.2. Сервисный режим
Сервисный режим служит для:
- задания конфигурации навигационного приемника;
- загрузки путевых точек в навигационный приемник;
- выгрузки трека и отмеченных точек;
Переход в сервисный режим осуществляется при постановке устройства на зарядную площадку.

##### 2.3.2.3. Встроенный Bluetooth модуль
