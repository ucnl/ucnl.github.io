...
##### 2.3.2.1. Сервисный режим
Для перехода в сервисный режим устройство должно быть установлено на подключенную к питанию зарядную площадку. При этом не важно, было ли устройство включено.
