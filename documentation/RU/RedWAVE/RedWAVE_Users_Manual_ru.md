...
> ВНИМАНИЕ! Система RedWave использует спутниковые навигационные системы в качестве источника навигационной информации для позиционирования буев-ретрансляторов, поэтому в условиях, когда осуществляется подавление (jamming) или подменя (spoofing) сигналов спутниковых навигцаионных систем, работа RedWave становится невозможна.
...
Предыдущие версии прибора оснащались дополнительно
- Bluetooth модулем;
- приемником беспроводного заряда.
...
> ВНИМАНИЕ!!! В предыдущих версиях прибор имел беспроводную зарядку и сопрягался с ПК при помощи Bluetooth. Работа с устройствами, оснащенными герморазъемами происходит практически таким же образом, за исключением того, что пользователь должен вместо установки устройства на зарядную площадку подключить его к ПК при помощи комплектного USB-донгла. При этом интерфейс не содержит иконки Bluetooth.
