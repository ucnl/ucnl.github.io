...
| _1 - Функция левой кнопки (переключение целей), 2 - статусы буев, 3 - азимут и дистанция до цели, 4 - функция правой кнопки (отметить текущее положение), 5 - температура воды, 6 - глубина (расстояние до поверхности), 7 - заряд встроенного аккумулятора |

В навигационном режиме главный экран содержит
