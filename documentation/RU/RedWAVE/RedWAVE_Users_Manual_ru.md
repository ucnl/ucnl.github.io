...
- в отсутствие следов коррозии на контактах зарядки и подключения сервисного кабеля (надводный блок)
...
- После использования контакты детектора воды (подводный блок) и контакты зарядки и подключения сервисного кабеля (надводный блок) должны быть промыты и просушены, во избежания их коррозии.

#### 2.1.5. Зарядка встроенного источника питания

Зарядка устройства производится при помощи комплектного аксессуара. 
