...
Для включения буя поместите нижнюю часть буя в воду так, чтобы в ней оказались контакты детектора воды.
После завершения сервисных операций отключите буй, отсоедините сервисный переходник.
