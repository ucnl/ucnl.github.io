...
[Главная](/README_RU) ❯ [Продукция для образования](/education_etc_ru) ❯ **ACoubes A<sup>3</sup>R: Спецификация устройства **
...
* **Совместимость с модулями A<sup>3</sup>T**
...
Устройства **A<sup>3</sup>R** могут объединятся с импульсным передатчиком **A<sup>3</sup>T** и совместно использовать одну гидроакустическую приемопередающую антенну.
