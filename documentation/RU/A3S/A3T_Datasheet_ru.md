...
* **Совместимость с модулями [A<sup>3</sup>R](A3R_Datasheet_ru)**
...
Устройство может объединятся с модулем приемника [**A<sup>3</sup>R**](A3R_Datasheet_ru) и совместно использовать одну гидроакустическую приемопередающую антенну.
Также устройство может объединятся со стеком (до 12 шт) из модулей приемников[**A<sup>3</sup>R**](A3R_Datasheet_ru). В этом случае каждый приемник и передатчик использует отдельную антенну.
