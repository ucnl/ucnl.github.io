...
Передатчик A<sup>3</sup>T излучает импульсы фиксированной частоты и длительности при изменении состояния на своем цифровой входе, которым управляет пользователь. 
Приемник A<sup>3</sup>R может улавливать эти импульсы и передавать пользователю, изменяя состояние своего цифрового выхода.
