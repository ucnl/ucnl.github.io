...
При проведении экспериментов на водоемах, полезно вести запись сигналов. Например, в обсуждаемых испытаниях гидрофон, на который велась запись, располагался в непосредственной близости от антенны запрашивающего устройства и ниже преставлены снимоки экрана, на которых представлены случайные фрагмены с одинм циклом "запрос-ответ" - для дальностей 80 и 156.
