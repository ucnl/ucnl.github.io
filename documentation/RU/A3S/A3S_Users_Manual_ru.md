...
* [1. A³T и A³R](#1-a3t-и-a3r)
  ...
  * [1.5. Проект 3 - Гидроакустический модем](#15-гидроакустический-модем)
...
> ДЛЯ САМОСТОЯТЕЛЬНОЙ РАБОТЫ:
> можно попробовать поменять различные временные значения с целью уменьшения длительности передачи, а соответственно и скорости передачи данных. Также можно попробовать вычислить и определить экспериментально получившуюся скорость передачи.
