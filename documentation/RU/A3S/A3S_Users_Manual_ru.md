...
* [1. A³T и A³R](#1-a3t-и-a3r)
  ...
  * [1.8. Проект 6 - Антенная решетка: измерение угла прихода сигнала](#18-проект-6---антенная-решетка-измерение-угла-прихода-сигнала)
...
### 1.8. Проект 6 - Антенная решетка: измерение угла прихода сигнала

> _Если вы не знаете, какой размер выборки вам подойдет, то можно взять число 216_ О. В. Верходанов, Астрофизик
