...
Даже на этом соотношении можно уже делать угломерную систему из двух приемников. Но, как мы говорили выше, так делать не стоит - ошибка измерения времени на одном из приемников приведет к совершенно неверному результату. 

Теперь давайте рассмотрим наш случай с четырьмя приемниками:

| <img width="737" height="600" alt="image" src="https://github.com/user-attachments/assets/3fc62e4f-d9db-4b2b-86bb-5239f44c4b64" /> |
| :---: |
| _Определение угла прихода сигнала методом линейной регрессии_ |

Давайте, как настоящие ученые сделаем какие-то допущения и что-нибудь постулируем наконец.
...
На схеме выше показана система координат с центром в первом приемнике, ось X направлено как обычно вправо, а вот по оси Y у нас откладывается время, умноженное на скорость распространения волны - скорость звука в воде.
