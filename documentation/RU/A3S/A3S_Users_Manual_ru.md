...
| | Приемник №4| Приемник №3| Приемник №2| Приемник №1 |
| :--- | :--- | :--- | :--- |
| 1|0|140|56|200 |
| 2|56|236|0|56 |
| 3|0|84|24|172 |
...
Прикинем на полу, как это все выглядит в сборе и какой у нас есть запас по длине кабеля.
...
В нашем случае всю конструкцию даже не пришлось размещать на воде:

| <img width="960" height="1280" alt="image" src="https://github.com/user-attachments/assets/b2c7a29f-fd72-4802-8561-be989fa94c56" /> |
| :---: |
| _Расположение антенны на бассейне_ |

Из-за жесткости кабеля антенны висят не ровно, но в нашем случае это не то чтобы совсем не влияет, но большого вклада в картину внести не должно. Тем более, что пользователь сам вполне может решить этот механический вопрос.
