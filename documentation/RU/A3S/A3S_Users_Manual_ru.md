...
### [1.2. Сценарий №1 - Передаем и принимаем](#12-сценарий-№1---передаем-и-принимаем)
...
### [1.4. Сценарий №2 - Собираем приемопередатчик и измеряем наклонную дальность](#14-сценарий-№2---собираем-приемопередатчик-и-измеряем-наклонную-дальность)
...
##### [1.4.2.1. Скетч №3 - Инициирует передачу и измеряет время между запросом и ответом](#1421-скетч-№3---инициирует-передачу-и-измеряет-время-между-запросом-и-ответом)
...
##### [1.4.4.1. Скетч №4 - Фиксированная задержка ответа](#1441-скетч-№4---фиксированная-задержка-ответа)
