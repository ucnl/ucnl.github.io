...
> Итак, у нас труба диаметром 25 мм, значит площадь сечения $&pi;r^2 = 3.1415*0.0125^2=0.000490859 м^2$. Длина всей использованной трубы 8 м, умножаем одно на другое и получаем объем вытесняемой воды: $0.000490859 * 8 = 0.003926875 м^3$. Масса этого объема воды, с учетом плотности в $1000 кг/м^3$ составит 3.9 кг. А измеренный вес всей конструкции всего 1.5 кг, значит у нас есть 3.9-1.5=2.4 кг избыточной плавучести.
