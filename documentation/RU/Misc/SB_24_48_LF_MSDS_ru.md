[Главная](/README_RU) ❯ [Дополнительные материалы](/misc_ru) ❯ **SB-24-48-LF MSDS RU**

<div style="page-break-after: always;"></div>

| ![logo](/documentation/sm_logo.png) | ![qr](/documentation/sb_24_48_lf_msds_ru_qr.png)  |
| :---: | ---: |
| [www.unavlab.com](https://www.unavlab.com/) <br/> [support@unavlab.com](mailto:support@unavlab.com) | Аккумулятор литий-железофосфатный 48 Вт·ч<br/> в составе сборки SB-24-48-LF ПМВР.134096.002 <br/> Паспорт безопасности химической продукции (MSDS) |
| | Версия 1 <br/> 10.06.2023 |

## Аккумулятор литий-железофосфатный Вт·ч <br/> в составе сборки SB-24-48-LF (48 Вт*ч) ПМВР.134096.002
...
| | |
| :--- | :--- |
| Торговое наименование | Аккумуляторная сборка SB-24-48-LF ПМВР.134096.002 |
| Номер статьи |
...
В случае разрушении корпуса аккумулятора происходит высвобождение составных веществ.  
...
| | |
| --- | --- |
| **14.1.** Номер ООН | UN 3481 |
| **14.2.** Собственное транспортное наименование ООН | Литий-ионные аккумуляторы, входящие в состав оборудования |
| **14.3.** Класс(ы) опасности при транспортировке <br/> Класс | Класс 9 |
...
## Используемые элементы (ячейки)

| Тип элемента | Типоразмер | Количество | Вес одной ячейки |
| :--- | :--- | :--- | :--- |
| LiFePO4 | 18650 | 8 | 42 грамма |

| Общий вес всех ячеек |
| 336 грамм |
