...
| 3 | rq_code | Идентификатор запрошенного у маяка параметра. [См. Таблицу 3.3. Идентификаторы запросов]() |
| 4 | rs_code | Код ответа маяка [См. Таблицу 3.5. Коды ответа]() |
...
| 1 | cmdID | Идентификатор команды, см. [Таблица 3.3. Адресные команды]() |
| | *	| разделитель контр. суммы NMEA |
| | hh | контрольная сумма NMEA |
| | \<CR\>\<LF\> | конец сообщения |
...
| 1 | cmdID | Идентификатор команды, см. [Таблица 3.4 Широковещательные команды]() |
| | *	| разделитель контр. суммы NMEA |
| | hh | контрольная сумма NMEA |
| | \<CR\>\<LF\> | конец сообщения |
...
| 6 | pts_type | Тип датчика давления см. []() |
