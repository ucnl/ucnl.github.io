...
| 1 | addrMask | Маска адреса маяков для опроса, 16-битное цело беззнаковое число, каждый бит от 0 до 15 соответствует одному из маяков, бит = 0 - маяк не учавствует в опросе, бит = 1 - маяк участвует в опросе. Если параметр пустой или равен нулю, то опрос останавливается. |
