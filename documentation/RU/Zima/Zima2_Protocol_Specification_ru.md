...
| 1 | cmdID | Идентификатор команды, см. [Таблица 3.5 Удаленные команды телеуправления]() |
| | *	| разделитель контр. суммы NMEA |
| | hh | контрольная сумма NMEA |
| | \<CR\>\<LF\> | конец сообщения |
...
| 1 | cmdID | Идентификатор команды, см. [Таблица 3.5 Удаленные широковещательные команды]() |
| | *	| разделитель контр. суммы NMEA |
| | hh | контрольная сумма NMEA |
| | \<CR\>\<LF\> | конец сообщения |
