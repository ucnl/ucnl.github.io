...
2. Запустите приложение **AzimuthConsole** убедитесь, что система настроена на работу только с одним маяком, выбранным для калибровки, и установите соединение с системой (команда `OCON`).
