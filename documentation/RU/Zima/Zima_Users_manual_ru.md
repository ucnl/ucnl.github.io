...
| ![ZHost settings window view](https://github.com/ucnl/ucnl.github.io/blob/master/documentation/zhost_setts_1.png) |
| :---: |
...
| ![ZHost settings window view](https://github.com/ucnl/ucnl.github.io/blob/master/documentation/zhost_setts_2.png) |
| :---: |
...
- Флажок "Антенна неподвижна" позволяет использовать функцию одновременной навигации если антенна установлена на неподвижном объекте (например, на пирсе или ином объекте портовой инфраструктуры). Тем самым давая понять системе, что не требуется использовать данные о направлении антенны относительно сторон света.
