...
| ![ZHost settings window view](https://github.com/ucnl/ucnl.github.io/blob/master/documentation/zhost_setts_3.png) |
| :---: |
...
Справа от каждого значения после 7 секунд отображется возраст данных - время, которое прошло с момента, когда значение параметра было обновлено.
