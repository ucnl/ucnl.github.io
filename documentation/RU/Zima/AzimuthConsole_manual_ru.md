...
Приложение предназначено для работы с системами [Zima2](/documentation/RU/Zima/Zima2_DataBrief_ru): конфигурирование пеленгационных антенн Zima2B, Zima2B-35, Zima2BK, обработки поступающей от них информации и передачи результатов по последовательному соединению и/или по UDP-соединению.
