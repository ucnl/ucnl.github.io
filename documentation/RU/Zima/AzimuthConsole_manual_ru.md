...
| 5 | MSR_dB | f32 | 14 ..  | Качество приема сигнала маяка-ответчика. Величины менее 20 дБ означают плохие условия | Измерение |
| 6 | age | f32 | 0 .. | Возраст предыдущих значений | Cистемные часы |
