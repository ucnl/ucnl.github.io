[Главная](/README_RU) ❯ [Гидроакустические навигационные и трекинговые системы](/navigation_and_tracking_systems_ru) ❯ **Спецификация устройства: Zima2-B35 - пеленгационная антенна**
...
**Zima2-B35** - пеленгационная станция ультракороткобазисной системы [Zima2 USBL](Zima2_DataBrief_ru.md).
...
маяков-ответчиков [Zima2-R35](Zima2R35_Specification_ru.md).
...
| МАКСИМАЛЬНАЯ АКУСТИЧЕСКАЯ ДАЛЬНОСТЬ СВЯЗИ<sup>[1](#footnote1)</sup> | 1000 м |
...
| РАЗРЕШЕНИЕ ПО ГЛУБИНЕ МАЯКОВ-ОТВЕТЧИКОВ | 1.4 м |
