...
После возникновения ошибочной ситуации по питанию, когда устройство отключает питание потребителей, после устранения причины ошибочной ситуации для возобновления питания потребителей, необходимо перезапустить устройство переведя тумблер **4** в положение **OFF** и отбратно в **ON**.
