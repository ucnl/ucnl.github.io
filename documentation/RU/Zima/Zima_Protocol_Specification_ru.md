...
| 0	| идентификатор сообщения \([см. 3.2.]()\) |
...
| LocDataID	| Строка наименование системы |
...
| LocDataID	| Идентификатор параметра |
...
| ActionID | Идентификатор операции |
...
| RequestID	Команда (всегда должно быть CDS_DPT_GET) |
