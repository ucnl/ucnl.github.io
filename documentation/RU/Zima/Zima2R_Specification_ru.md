...
Максимальное время работы маяка-ответчика в режиме приема составляет до 70 часов. Различные возможные варианты времени работы приведены ниже:

| ПЕРИОД ОПРОСА, сек | ВРЕМЯ РАБОТЫ, ч |
| :---:              | :---: |
| 1                  | 8 |
