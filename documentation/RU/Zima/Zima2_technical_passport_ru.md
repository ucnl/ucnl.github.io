...
Гидроакустическая пеленгационная антенна и маяки-ответчики выполнены по запатентованной технологии в виде полностью залитых в полиуретановый компаунд моноблоков и предназначены для работы в пресной и соленой воде (уровень солености до **38 PSU**), а также в диапазоне температур **от -5 до +50 °С**. 
...
Маяки-ответчики в автономном исполнении питаются от батарейных блоков на основе LiFePO4 (литий-железосфат) аккумуляторов емкостью от 36 до 98 Вт·ч.
...
- Для устройств Zima2-B (пеленгационная антенна) и Zima2-R (маяк-ответчик) серийные номера доступны программно и строго соответствуют заводским четырехзначным номерам. Заводской номер может наноситься на временную бирку, закрепленную на кабеле или наносится методом горячего клеймения на корпус устройства;
