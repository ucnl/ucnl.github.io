...
Для устройств Zima2-B (пеленгационная антенна) и Zima2-R (маяк-ответчик):
- серийные номера доступны программно и строго соответствуют заводским четырехзначным номерам. Заводской номер может наноситься на временную бирку, закрепленную на кабеле или наноситься методом горячего клеймения на корпус устройства;
