...
Датчик подключен к управляющей системе. И его режим работы по умолчанию - по запросу.  
...
>> $PTNT0,1023.260,28.12<CR><LF> // Данные о давлении и температуре: 1023.26 мБар, 28.12 °С  
>> $PTNT0,1022.870,28.20<CR><LF> // Данные о давлении и температуре: 1022.87 мБар, 28.20 °С  
...  
```
