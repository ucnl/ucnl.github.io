...
Приложение [💧 uNav](https://github.com/ucnl/uNav/releases/download/1.0/uNav.zip) предназначено для настройки и работы с навигационным решателем/радиодонглом [uNav RF Dongle](documentation/RU/RWLT/RWLT_RF_Dongle_Specification_ru.md).



Для отслеживание положения подводного объекта, такого, как ТНПА, АНПА, водолаз и т.п. при помощи пингера системы RWLT, на ПК оператора должно быть установлено приложение [💧 uNav](https://github.com/ucnl/uNav/releases/download/1.0/uNav.zip)
...
| Элементы управления вкладки "🧪 PHYSICS" окна настроек |
...
| |
| :---: |
| ![uNavHost](https://github.com/ucnl/ucnl.github.io/assets/24439946/08e4c4bb-8fc3-433d-9395-4e7abce826f2) |
| Основные элементы главного окна приложения |
| _1 - Главная панель инструментов, 2 - Панель инструментов карты, 3 - Поле карты, 4 - Поле дополнительной информации, 5 - Поле журнала, 6 - Панель дополнительных инструментов №1, 7 - Панель дополнительных инструментов №2, 8 - Строка статуса, 9 - Поле легенды, 10 - Панель масштаба_ |
