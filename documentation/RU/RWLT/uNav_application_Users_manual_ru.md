...
Содержит функции для статистической оценки точности работы системы. Данные функции можно задействовать только тогда, когда позиционируемый объект неподвижен в толще воды (например, стоит на дне). В противном случае это приведет к неверному рассчету.
