...
На рисунке ниже представлен общий вид главного окна приложения uTrackDiver с указанием основных элементов управления:
...
#### 2.2.1.1. Главная панель инструментов
