...
Особое внимание стоит уделять водолазным станциям беспроводной голосовой связи и маякам-пингерам: в виду того, что эти устройства имею встроенные источники питания на основе LiFePO4, они имеют очень пологую разрядную характеристику и определить степень заряда встроенного источника сложно. Пожтому рекомендуется перед использованием не раньше чем за 1-2 дня полностью выполнить зарядку всех устройств.
...
Следует помнить, что при использовании нескольких станций голосовой связи в одном водоеме им должны быть заданы **разные** адреса (**RWLT Diver's ID**).
