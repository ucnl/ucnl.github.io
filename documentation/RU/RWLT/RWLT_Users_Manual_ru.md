...
- 1 - Главная панель инструментов располагается в верхней части окна и содержит следующие элементы:
  ...
  - Группа кнопок **'📖 LOG'** - содержит функции для работы с файлами журналов
    - **'👀 View current**' - открыть текущий файл журнала в приложении, ассоциированном с расширением 'log' (как правило это Notepad)
    - **'▶ Playback...**'
