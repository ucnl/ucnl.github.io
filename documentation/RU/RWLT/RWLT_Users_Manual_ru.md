...
- Для отслеживания подводного объекта, оборудованного автономным пингером [RWLT Pinger](RWLT_Pinger_Specification_ru.md), на ПК оператора должно быть установлено приложение [uNav](https://github.com/ucnl/uNav/releases/download/1.0/uNav.zip)
