...
_**ПРОИЗВОДИТЕЛЬ ГАРАНТИРУЕТ, ЧТО ГИДРОАКУСТИЧЕСКАЯ ТРЕКИНГОВАЯ СИСТЕМА RWLT:**_  
...
_**- КОНСТРУКТИВНО НЕ МОЖЕТ БЫТЬ ИСПОЛЬЗОВАНА ДЛЯ СЛЕЖЕНИЯ ЗА ОБЪЕКТАМИ, НЕ ОСНАЩЕННЫМИ МАЯКАМИ-ПИНГЕРАМИ ИЛИ ВОДОЛАЗНЫМИ СТАНЦИЯМИ СВЯЗИ, РАССЧИТАНЫМИ НА СОВМЕСТНУЮ РАБОТУ С СИСТЕМОЙ**_  
_**- СОДЕРЖИТ ТОЛЬКО ГРАДЖАНСКИЕ НЕ ПОДЛЕЖАЩИЕ ЛИЦЕНЗИРОВАНИЮ РАДИОЧАСТОТНЫЕ МОДУЛИ: GNSS-ПРИЕМНИКИ И РАДИОМОДЕМЫ**_  
