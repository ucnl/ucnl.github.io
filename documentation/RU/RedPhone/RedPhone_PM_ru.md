...
Оператор надводной станции поочередно произносит слова из артикуляционных списков из [п. 6.5.]()  в разном порядке, каждое из которых должно быть повторено водолазом, после чего слово вычеркивается (или помечается) во избежание повторений.
