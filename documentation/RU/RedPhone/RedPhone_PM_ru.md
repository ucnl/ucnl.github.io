...
## 1. Описание системы
### 1.1. Назначение
Система беспроводной гидроакустической голосовой связи **RedPhone** предназначена для обеспечения голосовой связи между водолазами и надводным пунктом контроля за спусками.
...
| Исполнение | IP67[<sup>3</sup>](#footnote3) |
