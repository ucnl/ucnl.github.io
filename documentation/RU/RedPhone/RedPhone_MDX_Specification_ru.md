[Главная](/README_RU) ❯ [Голосовая подводная связь (водолазная телефония)](/underwater_wireless_voice_systems_ru) ❯ **Спецификация устройства: RedPhone-MDX**
...
* **Дальность связи до 5000<sup>[2](#footnote2)</sup> м**
...
| МАКСИМАЛЬНАЯ ДАЛЬНОСТЬ АКУСТИЧЕСКОЙ СВЯЗИ<sup>[2](#footnote2)</sup> | 5000 м |
| МАКСИМАЛЬНОЕ АКУСТИЧЕСКОЕ ДАВЛЕНИЕ | 174 дБ re 1 мкПа @ 1 м |
...
| ПЕРЕКЛЮЧЕНИЕ КАНАЛОВ СВЯЗИ | Через разъем и комплектный кабель, при помощи ПК |
