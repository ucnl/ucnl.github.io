...
* **Автономность до 80 часов в режиме приема**
...
| МАКСИМАЛЬНАЯ ГЛУБИНА ПОГРУЖЕНИЯ | 100 m |
...
| ВСТРОЕННЫЙ ИСТОЧНИК ПИТАНИЯ | 28 Ватт-часов, LiFePO4, до 3000 циклов заряд-разряд |
| ПЕРЕКЛЮЧЕНИЕ КАНАЛОВ | В надводном положении, при помощи USB-радиодонгла |
...
<a name="footnote7"><sup>8</sup></a> В режиме 5 минут передачи 5 минут приема.  
