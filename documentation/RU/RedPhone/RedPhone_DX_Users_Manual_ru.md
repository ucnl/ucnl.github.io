...
Настройка станции осуществляется при подключении к ПК или при помощи устройства на основе ОС Android. В обоих случаях необходимо подключить станцию к устройству при помощи сервисного USB-кабеля. 
