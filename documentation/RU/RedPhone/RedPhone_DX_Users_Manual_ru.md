...
### 1.1. Назначение
Водолазная станция голосовой гидроакустической связи [RedPhone](RedPhone_DX_Specification_ru.md) (далее - станция) предназначена для 
...
Прибор выполнен в виде необслуживаемого моноблока, залитого в высокопрочный полиуретановый компаунд.  
...
| МАКСИМАЛЬНОЕ ВРЕМЯ АВТОНОМНОЙ РАБОТЫ В РЕЖИМЕ ПРИЕМА<sup>[5](#footnote5)</sup> | до 80 часов |
| МАКСИМАЛЬНОЕ ВРЕМЯ АВТОНОМНОЙ РАБОТЫ В СМЕШАННОМ РЕЖИМЕ (20%)<sup>[5](#footnote5),[6](#footnote6)</sup> | до 5 часов |
...
| НЕСУЩАЯ ЧАСТОТА НАВИГАЦИОННОГО СИГНАЛА<sup>[8](#footnote8)</sup> | 20050 Гц |
...
<a name="footnote6"><sup>6</sup></a> В режиме 2 минут передачи 8 минут приема.  
<a name="footnote7"><sup>6</sup></a> В режиме 5 минут передачи 5 минут приема.  
...
Прибор имеет обслуживаемый батарейный отсек, в котором располагается 3 Li-Ion аккумулятора типоразмера 18650. Демонтаж крышки батарейного отсека должен производится только лицами, имеющими соответствующую квалификацию и только для изменения настроек каналов и/или переключения совместимости с навигационной системой **RWLT**, а также для замены аккумуляторов по истечении их срока службы. 
Крайне не рекомендуется часто открывать и закрывать батарейный отсек с целью быстрой замены разряженных аккумуляторов на заряженные: пользователь должен следить за состоянием заряда аккумулятров и своевременно заряжать их, особенно перед использованием.

Для снятия и установки крышки батарейного отсека:
- расположить прибор на столе, поставив на узкую сторону, антенной от себя;
- при помощи идущей в комплекте биты и шестигранной отвертки h2.5 мм поочередно ослабить (на 3-4 оборота) 8 винтов крышки (см. **рисунок 3**);
- полностью выкрутить винты крышки;
- вынуть болты и гайки, снять крышку;
- расположить прибор горизонтально;
- *при необходимости аккуратно извлечь аккумуляторы при необходимости поддевая из за торец плоским непроводящим инструментом;*
- *при необходимости аккуратно установить новые аккумуляторы, соблюдая полярность установки;*
- *при необходимости выполнить настройку прибора при помощи переключателя;*
- убедиться в целостности уплотнительного кольца и при необходимости смазать его густой силиконовой смазкой;
- убедиться в отсутствие посторонних предметов (соринок, волосков и т.п.) на уплотнительном кольце и канавке;
- установить крышку баратейного отсека;
- вставить болты;
- прижимая рукой крышку перевернуть прибор на ребро и наживить 4 гайки по краям крышки;
- слегка притянуть гайки для исключения соскальзывания уплотнительного кольца;
- установить оставшиеся гайки и полностью закрутить так, чтобы между крышкой и корпусом не осталось щелей.
