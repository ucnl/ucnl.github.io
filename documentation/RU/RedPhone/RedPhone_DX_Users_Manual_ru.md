...
| Цифрами обозначены: *1 - станция RedPhone-DX, 2 - зарядное устройство, 3 - USB-донгл (переходник)* |
...
Настройка станции осуществляется при подключении к ПК или при помощи устройства на основе ОС Android. В обоих случаях необходимо подключить станцию к устройству при помощи USB-кабеля. 
...
Отключите USB-донгл от ПК или устройству Android/HarmonyOS, если он присоединен.
...
Подключите USB-донгл к станции RedPhone-DX и включите станцию. 
...
Подсоедините USB-донгл к ПК или к устройству Android/HarmonyOS.
