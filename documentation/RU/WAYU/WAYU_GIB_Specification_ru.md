...
<a name="footnote4"><sup>4</sup></a> Достигается при отсутствие помех, на открытой местности. Приемную антенну может потребоваться поднять выше над землей на несколько метров. 
