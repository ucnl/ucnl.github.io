...
| Максимальный размер покрываемой области            | 700 х 700 м           | 1500 x 1500 м   | круг R = 8000 м      | 300 x 300 м     | круг R = 1000 м |
...
| Отличительная черта | Неограниченное число одновременно позиционируемых устройств | Позиционирование водолазов одновременно с голосовой передачей | Функция передачи управляющих кодовых посылок | WAYU | Двусторонняя передача данных |
|
