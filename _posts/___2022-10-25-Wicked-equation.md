...
Вот отсюда и предполагается получить желаемое $r$ при известных остальных параметрах. Уравнение такое аналитически не решается (во всяком случае ни я ни мои коллеги не знают как это сделать). Но мы можем решать его численными методами!
