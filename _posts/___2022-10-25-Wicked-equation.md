...
А еще звуковые волны в рассеиваются на разных объемных неоднородностях:
- неоднородностях полей [скорости звука](https://habr.com/ru/post/497314/)
- пузырькаях газа в приповерхностном слое (который в разных местах может быть толщиной в десятки метров!)
