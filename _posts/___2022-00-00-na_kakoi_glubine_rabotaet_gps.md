...
Теперь, мне кажется, что масштаб явления теперь примерно понятен. 
...
Что же касаемо GPS - то там все еще более прозаично. Под спойлером ниже
<details>
  <summary>таблица с частотами существующих GNSS</summary>
